...
public class mainClass {
	...
	public static void main(String[] args) throws IOException {
		...
		columns.add("titlePub"); columns.add("DescriptionPub");
		columns.add("InfoPub"); columns.add("datePub_begin");
		columns.add("datePub_end"); columns.add("post_prop");
		columns.add("secteur_activite"); columns.add("fonction");
		columns.add("experience_requise"); columns.add("niv_etd_dem");
